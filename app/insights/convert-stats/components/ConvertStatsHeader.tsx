...
import { P, PERIOD_OPTIONS } from "@/lib/convert-stats/data";
import { useOverviewCampaigns } from "@/hooks/use-reach-overview";

interface ConvertStatsHeaderProps {
...
export function ConvertStatsHeader({
  selectedCampaigns,
  selectedPeriod,
  customDateRange,
  onCampaignChange,
                    ...
                    apiCampaigns.map((c) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          />
                          <span style={{ flex: 1, fontWeight: selected ? 600 : 400, color: P.text1 }}>{c.name}</span>
                          {selected && (
