...
const actionableInsights: ActionableInsight[] = [
  {
    id: "1",
    insight: "Intent building",
    insightDetails: "AQS increased to 70 (+3pts)  ACR improved to 51% (+5pts)",
    metrics: [
      { label: "AQS increased to", value: "70 (+3pts)" },
      { label: "ACR improved to", value: "51% (+5pts)" },
    ],
    action: "Expose trial entry earlier",
    actionDetails:
      "Surface trial CTA higher in the pricing page flow to capture high-intent visitors before drop-off.",
    expectedImpact: [{ metric: "Expected: ACR", value: "51% → 58%" }],
    channels: ["Website", "HubSpot"],
    priority: "high",
    confidence: 94,
    effort: "low",
    timeframe: "2-3 days",
  ...
  {
    id: "2",
    insight: "Trial hesitation",
    insightDetails: "Current AIS 8.0",
    metrics: [{ label: "Current AIS", value: "8.0" }],
    action: "Convert content evaluators",
    actionDetails:
      "Add contextual trial prompts within high-performing case studies to convert engaged readers.",
    expectedImpact: [{ metric: "Expected: Conversions", value: "+15-20%" }],
    channels: ["Website", "Marketing Automation"],
    priority: "high",
    confidence: 89,
    effort: "low",
    timeframe: "1-2 days",
  ...
  {
    id: "3",
    insight: "Content-led evaluation",
    insightDetails: "AIS improvement +14%",
    metrics: [{ label: "AIS improvement", value: "+14%" }],
    action: "Scale evaluation-driven campaigns",
    actionDetails:
      "Increase budget allocation to content-driven channels showing stronger engagement and lower CpQV.",
    expectedImpact: [{ metric: "Expected: CpQV", value: "$3.14 → $2.90" }],
  ...
  {
    id: "4",
    insight: "Channel quality imbalance",
    insightDetails: "CpQV variance $3.14 avg",
    metrics: [{ label: "CpQV variance", value: "$3.14 avg" }],
    action: "Reduce inefficient acquisition",
    actionDetails:
      "Pause or optimize underperforming ad sets with high CpQV and low quality signals.",
    expectedImpact: [{ metric: "Expected: AIS", value: "8.0 → 8.8" }],
      ...
      >
          ...
          <div style={{ background: "linear-gradient(to right, #F8F7FF, #FAFBFF)", borderBottom: "1px solid #E5E5E7", padding: "16px 32px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div>
                ...
                <div style={{ fontSize: 15, fontWeight: 700, color: "#1D1D1F" }}>Act Phase • AgentIQ – Your Marketing Co-Pilot</div>
              </div>
        ...
        <div style={{ borderTop: "1px solid #E5E5E7", padding: 16, background: "#FAFAFA" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#fff", border: "1px solid #D2D2D7", borderRadius: 8, padding: "12px 16px" }}>
            ...
            <input
              type="text"
              placeholder="Ask AgentIQ anything about your Act Phase insights..."
              disabled
...
// ─── Main Section ─────────────────────────────────────────────
export function AIPoweredInsightsSection() {
